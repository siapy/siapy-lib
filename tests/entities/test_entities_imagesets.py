...
def test_len(configs):
    ...
    vnir_image = create_spectral_image(configs.image_vnir_hdr_path, configs.image_vnir_img_path)
    swir_image = create_spectral_image(configs.image_swir_hdr_path, configs.image_swir_img_path)
...
def test_images_by_camera_id(configs):
    vnir_image1 = create_spectral_image(configs.image_vnir_hdr_path, configs.image_vnir_img_path)
    vnir_image2 = create_spectral_image(configs.image_vnir_hdr_path, configs.image_vnir_img_path)
    swir_image = create_spectral_image(configs.image_swir_hdr_path, configs.image_swir_img_path)
    ...
    assert [vnir_image1, vnir_image2] == image_set.images_by_camera_id(configs.image_vnir_name)


def test_sort(configs):
    vnir_image1 = create_spectral_image(configs.image_vnir_hdr_path, configs.image_vnir_img_path)
    vnir_image2 = create_spectral_image(configs.image_vnir_hdr_path, configs.image_vnir_img_path)
    swir_image1 = create_spectral_image(configs.image_swir_hdr_path, configs.image_swir_img_path)
    swir_image2 = create_spectral_image(configs.image_swir_hdr_path, configs.image_swir_img_path)
    swir_image3 = create_spectral_image(configs.image_swir_hdr_path, configs.image_swir_img_path)
