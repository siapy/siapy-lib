...
class CreateStudyConfig(BaseModel):
    ...
    direction: Literal["maximize", "minimize"] | optuna.study.StudyDirection | None = "minimize"
...
class OptimizeStudyConfig(BaseModel):
    ...
    callbacks: list[Callable[[optuna.study.Study, optuna.trial.FrozenTrial], None]] | None = None
